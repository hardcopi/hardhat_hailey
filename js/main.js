...
LoadingState.preload = function () {
    this.game.load.json('level:999', 'data/gameover.json');
    ...
    this.game.load.image('background', 'images/factory.png');
    ...
    this.game.load.spritesheet('hero', 'images/hailey.png', 29, 42);
    this.game.load.spritesheet('hero_stopped', 'images/hailey.png', 36, 42);
    this.game.load.spritesheet('coin', 'images/coin_animated.png', 22, 22);
    this.game.load.spritesheet('spider', 'images/spider.png', 42, 32);
    this.game.load.spritesheet('dozer', 'images/dozer.png', 40, 32);
...
PlayState.update = function () {
    ...
    this.numberLivesFont.text = `x${this.numberLivesCount}`;
...
PlayState._onHeroVsEnemy = function (hero, enemy) {
    ...
    if (hero.body.velocity.y > 0) {
        ...
        this.numberLivesCount -= 1;
        hero.die();
        this.sfx.stomp.play();
        hero.events.onKilled.addOnce(function () {
            console.log("Number of Lives: " + this.numberLivesCount);
            if (this.numberLivesCount < 1) {
...
window.onload = function () {
    // let game = new Phaser.Game(window.innerWidth * window.devicePixelRatio, window.innerHeight * window.devicePixelRatio, Phaser.CANVAS, 'game');
